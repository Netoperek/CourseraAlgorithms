...
class HeapTest < Test::Unit::TestCase
  def test_heap_min
    ...
    heap_min.insert(17)
    assert_equal([2, 7, 36, 17, 25], heap_min.heap)

    heap_min.insert(3)
    assert_equal([2, 3, 7, 17, 25, 36], heap_min.heap)

    heap_min.insert(100)
    assert_equal([2, 3, 7, 17, 25, 36, 100], heap_min.heap)

    heap_min.insert(1)
    assert_equal([1, 2, 7, 3, 25, 36, 100, 17], heap_min.heap)

    assert_equal(heap_min.extract_min, 1)
    assert_equal([2, 3, 7, 17, 25, 36, 100], heap_min.heap)

    assert_equal(heap_min.extract_min, 2)
    assert_equal([3, 17, 7, 100, 25, 36], heap_min.heap)

    assert_equal(heap_min.extract_min, 3)
    assert_equal([7, 17, 36, 100, 25], heap_min.heap)
  ...
  def test_heap_max
    ...
    heap_max.insert(36)
    assert_equal([36, 25, 7], heap_max.heap)

    heap_max.insert(2)
    assert_equal([36, 25, 7, 2], heap_max.heap)

    heap_max.insert(17)
    assert_equal([36, 25, 7, 17, 2], heap_max.heap)

    heap_max.insert(3)
    assert_equal([36, 25, 7, 17, 2, 3], heap_max.heap)
    
    heap_max.insert(100)
    assert_equal([100, 36, 25, 17, 2, 7, 3], heap_max.heap)

    heap_max.insert(1)
    assert_equal([100, 36, 25, 17, 2, 7, 3, 1], heap_max.heap)

    assert_equal(heap_max.extract_max, 100)
    assert_equal([36, 17, 25, 1, 2, 7, 3], heap_max.heap)

    assert_equal(heap_max.extract_max, 36)
    assert_equal([25, 17, 7, 1, 2, 3], heap_max.heap)

    assert_equal(heap_max.extract_max, 25)
    assert_equal([17, 3, 7, 1, 2], heap_max.heap)

    assert_equal(heap_max.extract_max, 17)
    assert_equal([7, 3, 2, 1], heap_max.heap)
    
    assert_equal(heap_max.extract_max, 7)
    assert_equal([3, 1, 2], heap_max.heap)
